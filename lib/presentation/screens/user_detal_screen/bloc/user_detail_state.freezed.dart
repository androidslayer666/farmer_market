...
class _$UserDetailStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      phoneIsValid: phoneIsValid == freezed
          ? _value.phoneIsValid
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'UserDetailState(name: $name, phoneIsValid: $phoneIsValid, phone: $phone, haveUserInfoOnServer: $haveUserInfoOnServer, description: $description, isLoading: $isLoading, isImageLoading: $isImageLoading, logOutIsClicked: $logOutIsClicked, userDetailStatus: $userDetailStatus, avatarFile: $avatarFile)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.phoneIsValid, phoneIsValid) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(phoneIsValid),
